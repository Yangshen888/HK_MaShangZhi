...
namespace HaiKanStudentDiningManagementSystem.Api.Controllers.Api.V1
{
    [Route("api/v1/[controller]/[action]")]
    [ApiController]
    [HaiKanStudentDiningManagementSystem.Api.Extensions.CustomException.CustomAuthorize]
