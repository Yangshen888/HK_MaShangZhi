      ...
      stores: {
        icon: {
          ...
          columns: [
            ...
            { title: "图标名称", key: "code", width: 250, sortable: true,required:"前填写图标名称" },
            { title: "自定义", key: "custom", width: 150 ,required:"前填写自定义"},
            { title: "大小", key: "size", width: 60 ,required:"前填写大小"},
            { title: "颜色", key: "color", width: 80 ,required:"前填写颜色"},
            {
              title: "状态",
              key: "status",
              align: "center",
