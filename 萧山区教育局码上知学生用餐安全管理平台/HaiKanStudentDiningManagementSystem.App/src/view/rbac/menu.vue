      ...
      stores: {
        menu: {
          ...
          columns: [
            ...
            { title: "菜单名称", key: "name", sortable: true,minWidth:200,required:"前填写菜单名称" },
            {
              title: "请求地址",
              key: "url",
              width: 250,
              sortable: false,
              ellipsis: true,
              tooltip: true,required:"前填写请求地址"
            },
            { title: "路由名称", key: "alias", width: 200,required:"前填写路由名称" },
            { title: "上级菜单", key: "parentName", width: 150,required:"前填写上级菜单" },
