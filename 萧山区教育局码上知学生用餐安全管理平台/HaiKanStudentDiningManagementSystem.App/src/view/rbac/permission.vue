      ...
      stores: {
        permission: {
          ...
          columns: [
            ...
            { title: "权限名称", key: "name", width: 250, sortable: true,required:"前填写权限名称" },
            { title: "关联菜单", key: "menuName", width: 250,required:"前填写关联菜单" },
            { title: "操作码", key: "actionCode", minWidth:200,required:"前填写操作码" },
            {
              title: "状态",
              key: "status",
              align: "center",
